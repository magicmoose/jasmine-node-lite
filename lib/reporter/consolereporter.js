...
function configureEvents(self, reportDispatcher) {
    ...
    reportDispatcher.on('jasmineStarted', onJasmineStarted);
    reportDispatcher.on('jasmineDone', onJasmineDone);
    reportDispatcher.on('suiteStarted', onSuiteStarted);
    reportDispatcher.on('suiteDone', onSuiteDone);
    reportDispatcher.on('specStarted', onSpecStarted);
    reportDispatcher.on('specDone', onSpecDone);
}
